// upto/frontend/components/layout/ManagementLayout.js
...
const navigation = [
  { name: 'داشبورد', href: '/manage/dashboard', icon: HomeIcon },
  { name: 'رویدادها', href: '/manage/events', icon: CalendarIcon },
  { name: 'کتابخانه رسانه', href: '/manage/library', icon: FolderIcon },
  { name: 'کاربران', href: '/manage/users', icon: UsersIcon },
];
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100">
        <div className="text-center">
          <p className="text-lg font-semibold text-gray-700">در حال بارگذاری پنل مدیریت...</p>
        </div>
      </div>
    );
  }
              ...
              >
                <Dialog.Panel className="relative mr-auto flex h-full w-full max-w-xs flex-1">
                  <Transition.Child
                    ...
                    leaveTo="opacity-0"
                  >
                    <div className="absolute left-0 top-0 -ml-8 flex w-8 items-center justify-center pt-4 sm:-ml-10">
                      <button
                        type="button"
                        className="relative rounded-full p-2.5 text-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white"
